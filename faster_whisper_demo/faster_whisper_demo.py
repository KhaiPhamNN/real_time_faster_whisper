...
def main():
    ...
    audio_model = WhisperModel(args.model, device="cpu", compute_type="int8")
    
    # or run on GPU with FP16
    # audio_model = WhisperModel(args.model, device="cuda", compute_type="float16")
    # or run on GPU with INT8
    # audio_model = WhisperModel(args.model, device="cuda", compute_type="int8_float16")
